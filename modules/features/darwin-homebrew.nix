...
in
{
  flake.modules.darwin.homebrew =
    ...
    in
    {
      ...
      environment.variables.SSH_AUTH_SOCK = mkIfCaskPresent "1password-cli@beta" "/Users/dario/Library/Group Containers/2BUA8C4S2C.com.1password/t/agent.sock";
    };
}
